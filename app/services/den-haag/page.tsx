...
export const metadata: Metadata = {
  title: 'Web Design & Development Den Haag (The Hague) | BuildWebs.eu',
  description: 'Professional web design and development in Den Haag / The Hague. Government, corporate, and business websites.',
  keywords: 'web design Den Haag, web development The Hague, website Den Haag, WordPress Den Haag, SEO The Hague',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Web Development in <span className="gradient-text">Den Haag</span>
            </h1>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">
              Professional websites for businesses in The Hague. Government-ready, secure, and compliant web solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/#contact" className="btn-primary text-lg">Request Quote</Link>
              <Link href="#services" className="btn-secondary text-lg">Services</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-dark-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-electric-blue/10 to-neon-turquoise/10 p-12 rounded-3xl border border-electric-blue/30 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Let's Build Your Website in Den Haag</h2>
